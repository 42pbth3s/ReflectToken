...
import {ReflectErc20OnBase} from "../src/ReflectErc20OnBase.sol";
...
contract RewardLogicOnBase is Test {
        
    ReflectErc20OnBase                      public              TokenContract;
    ...
    function setUp() public {
        ...
        vm.startPrank(Owner);
        TokenContract = new ReflectErc20OnBase(TeamWallet, 10_000_000_000 ether, 0);
        vm.stopPrank();

        RewardWallet = address(TokenContract);

        console.log("                     $REFLECT: %s", address(TokenContract));
        console.log("               UNI V2 FACTORY: %s", address(0x8909Dc15e40173Ff4699343b6eB8132c65e18eC6));
